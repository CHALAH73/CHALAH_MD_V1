...
cmd({
    ...
    try {
        ...
        const channelLink = "https://whatsapp.com/channel/0029Vb3v0Fe1dAvw1XUIV61t";
...
cmd({
    ...
    try {
        ...
        const supportLink = "https://whatsapp.com/channel/0029Vb3v0Fe1dAvw1XUIV61t";

        // Send the support link to the user
        reply(`*ɴᴇᴇᴅ ʜᴇʟᴘ ᴏʀ ʜᴀᴠᴇ ǫᴜᴇsᴛɪᴏɴs ? ᴊᴏɪɴ CHALAH MD  sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ🪀*\n\n${supportLink}\n\n
